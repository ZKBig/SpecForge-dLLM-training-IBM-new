...
torchrun --nnodes=$NNODES \
    ...
    --confidence-alpha 1.0 \
    --confidence-mode trajectory \
    ...
    --output-dir /proj/checkpoints/zwang619/hybrid_out/xpress-sgu-14b-b7shift-scratch-gb512-conf \
    --report-to wandb \
    --wandb-project ripple-dspark \
    --wandb-name xpress-sgu-14b-b7shift-scratch-gb512-conf \
    --resume \
