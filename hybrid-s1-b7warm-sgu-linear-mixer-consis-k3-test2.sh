...
torchrun --nnodes=$NNODES \
    ...
    --mixer-init zeros \
    --output-dir /proj/checkpoints/zwang619/hybrid_out/xpress-consis-b7-k3-test2 \
    --report-to wandb \
    --wandb-project ripple-dspark \
    --wandb-name xpress-consis-b7-k3-test2 \
    --resume \
